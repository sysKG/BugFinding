...
if __name__ == "__main__":
    ...
    #
    # categories = FileUtil.load_pickle(PathUtil.get_categories_filepath())
    # concepts = FileUtil.load_pickle(PathUtil.get_concepts_filepath())
    # actions = FileUtil.load_pickle(PathUtil.get_actions_filepath())
    #
    # for category in categories:
    #     print(category)
    #
    ...
    """
        SBertModel.SENTENCE_TRANSFORMER.encode
    """
    bugs = FileUtil.load_pickle(PathUtil.get_filtered_bugs_with_atomic_steps_object_filepath())
